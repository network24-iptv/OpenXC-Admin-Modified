    ...
    $columns = array(
        ...
        array('db' => 'member_id', 'dt' => 3,
			'formatter' => function( $d, $row ) {              
			   return getRegisteredUserbyID($d);
			}
        ),
        ...
        array('db' => 'id', 'dt' => 9,
            'formatter' => function( $d, $row ) {
				...
				$rButtons .= '<a href="http://web24.live:25461/get.php?username='.$row["username"].'&password='.$row["password"].'&type=m3u_plus&output=ts"><button type="button" class="btn btn-outline-info waves-effect waves-light btn-xs"><i class="mdi mdi-download-outline"></i></button></a>';
